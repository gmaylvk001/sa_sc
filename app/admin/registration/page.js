          ...
          <div className="bg-white p-6 rounded-lg shadow-lg w-96">
            ...
            >
              <div className="mb-4">
				...
				<select name="class" value={contactToEdit?.class || ""} onChange={(e) =>
                    setContactToEdit({ ...contactToEdit, class: e.target.value })
              ...
              <div className="mb-4">
                ...
                <input type="date"
                  value={contactToEdit?.date_of_birth || ""}
                  onChange={(e) =>
                    setContactToEdit({ ...contactToEdit, date_of_birth: e.target.value })
                  }
                  className="border px-3 py-2 rounded-md w-full"
                  rows="3"
                />
			  ...
			  <div className="mb-4">
                ...
                <input
                  type="text"
                  value={contactToEdit?.parent_or_guardian || ""}
                  onChange={(e) =>
                    setContactToEdit({ ...contactToEdit, parent_or_guardian: e.target.value })
                  }
                  className="border px-3 py-2 rounded-md w-full"
                  required
                />
