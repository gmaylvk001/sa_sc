...
{/* Email */}
              ...
              {/* Phone Number*/}
								<div>
									...
									<input type="text" name="phone_number" value={form.phone_number} onChange={handleChange} className={`${inputClass} ${errors.phone_number && (touched.phone_number || submitted) ? "border-red-500" : "border-gray-300"}`} />
								</div>
